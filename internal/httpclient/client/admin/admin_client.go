...
type ClientService interface {
	...
	CreateGrantTypeJwtBearer(params *CreateGrantTypeJwtBearerParams) (*CreateGrantTypeJwtBearerCreated, error)
	...
	DeleteGrantTypeJwtBearer(params *DeleteGrantTypeJwtBearerParams) (*DeleteGrantTypeJwtBearerNoContent, error)
	...
	GetGrantTypeJwtBearer(params *GetGrantTypeJwtBearerParams) (*GetGrantTypeJwtBearerOK, error)

	GetGrantTypeJwtBearerList(params *GetGrantTypeJwtBearerListParams) (*GetGrantTypeJwtBearerListOK, error)
...
/*
  CreateGrantTypeJwtBearer creates a new jwt bearer grant
...
*/
func (a *Client) CreateGrantTypeJwtBearer(params *CreateGrantTypeJwtBearerParams) (*CreateGrantTypeJwtBearerCreated, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewCreateGrantTypeJwtBearerParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "createGrantTypeJwtBearer",
		Method:             "POST",
		...
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &CreateGrantTypeJwtBearerReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	success, ok := result.(*CreateGrantTypeJwtBearerCreated)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for createGrantTypeJwtBearer: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
  DeleteGrantTypeJwtBearer deletes jwt bearer grant
...
*/
func (a *Client) DeleteGrantTypeJwtBearer(params *DeleteGrantTypeJwtBearerParams) (*DeleteGrantTypeJwtBearerNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewDeleteGrantTypeJwtBearerParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "deleteGrantTypeJwtBearer",
		Method:             "DELETE",
		...
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &DeleteGrantTypeJwtBearerReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	success, ok := result.(*DeleteGrantTypeJwtBearerNoContent)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for deleteGrantTypeJwtBearer: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
  GetGrantTypeJwtBearer fetches jwt bearer grant information
...
*/
func (a *Client) GetGrantTypeJwtBearer(params *GetGrantTypeJwtBearerParams) (*GetGrantTypeJwtBearerOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetGrantTypeJwtBearerParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "getGrantTypeJwtBearer",
		Method:             "GET",
		PathPattern:        "/grants/jwt-bearer/{id}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &GetGrantTypeJwtBearerReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	success, ok := result.(*GetGrantTypeJwtBearerOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getGrantTypeJwtBearer: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
  GetGrantTypeJwtBearerList fetches all jwt bearer grants

  This endpoint returns list of jwt-bearer grants. Grant represents resource owner (RO) permission
for client to act on behalf of the RO. In this case client uses jwt to request access token to act as RO.
*/
func (a *Client) GetGrantTypeJwtBearerList(params *GetGrantTypeJwtBearerListParams) (*GetGrantTypeJwtBearerListOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetGrantTypeJwtBearerListParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "getGrantTypeJwtBearerList",
		Method:             "GET",
		PathPattern:        "/grants/jwt-bearer",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &GetGrantTypeJwtBearerListReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	success, ok := result.(*GetGrantTypeJwtBearerListOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getGrantTypeJwtBearerList: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
